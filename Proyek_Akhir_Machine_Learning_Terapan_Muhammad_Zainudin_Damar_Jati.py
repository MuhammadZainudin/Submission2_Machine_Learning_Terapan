# -*- coding: utf-8 -*-
"""(Final)Submission2_Machine_Learning_Terapan_Recommender_System.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TFw_MW1_0LDuf75HWImnnag8YZ5qGd2B

#Proyek Machine Learning Recommender System - Muhammad Zainudin Damar Jati

## 1. Project Overview
Proyek ini bertujuan membangun sistem rekomendasi anime untuk membantu pengguna menemukan tontonan yang sesuai berdasarkan minat dan preferensi mereka. Sistem ini sangat relevan untuk platform seperti MyAnimeList, Netflix, dan Crunchyroll yang memiliki ratusan hingga ribuan judul anime. Dengan rekomendasi yang akurat, pengalaman pengguna menjadi lebih personal dan efisien.
...
1. **Bagaimana memberikan rekomendasi anime berdasarkan kemiripan konten?**
2. **Bagaimana memanfaatkan riwayat rating pengguna untuk menyarankan anime yang relevan secara personal?**

### Goals

1. Menghasilkan sistem rekomendasi berbasis genre (konten).
2. Menghasilkan sistem rekomendasi berbasis prediksi rating pengguna terhadap anime.

### Solution Statements

* **Content-Based Filtering**: Menggunakan TF-IDF dan cosine similarity untuk menghitung kemiripan antar anime berdasarkan genre.
* **Collaborative Filtering**: Menggunakan model matrix factorization (SVD) untuk mempelajari pola rating pengguna dan memprediksi rating baru.
